...
<input name='event_name' type="text" className="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:border-blue-500" />
</div>
<div className='my-4'>
        <label htmlFor="event_desc" className="block text-gray-700">Event Description:</label>
<input name='event_desc' type="text" className="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:border-blue-500" />
</div>
<div className='my-4'>
        <label htmlFor="event_name" className="block text-gray-700">Date and Time for event:</label>
<input name='event_name' type="datetime-local" className="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:border-blue-500" />
</div>
