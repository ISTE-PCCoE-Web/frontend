...
const EventsCard = ({ img, eventTitle, eventDescription, eventType }:any) => {
  const navigate = useNavigate();
    return (
    <Flex w={{base: "100%", md:"80%"}} mx="auto" gap="1.5rem" flexDir={{base: "column", md: "row"}} borderRadius="1.5rem" justifyContent="space-between" padding="1.5rem" alignItems="center" background="linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(43,241,251,1) 25%, rgba(0,145,255,1) 59%, rgba(43,241,251,1) 91%)">
